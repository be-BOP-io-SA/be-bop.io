import type { PeerfundingClosedTranslations } from "./types";

export const fr: PeerfundingClosedTranslations = {
  hero: {
    eyebrow: "Peerfunding be-BOP · 27 avril – 9 juin 2026 · Campagne terminée",
    title: "Nous avons construit <em>PipeliNostr</em> ensemble",
    subtitle:
      "Merci à toutes celles et ceux qui ont soutenu cette campagne.<br><strong>Objectif dépassé. Communauté au rendez-vous.</strong>",
    video: {
  ...
  closedBanner: {
    badge: "Campagne terminée",
    title: "Nous avons dépassé notre objectif !",
    raised: "6 600 €",
    raisedLabel: "collectés",
    goal: "5 000 €",
    goalLabel: "objectif",
    percent: "132 %",
    percentLabel: "financé",
    thanks:
      "Un immense merci à chaque soutien qui a rendu PipeliNostr possible. Votre confiance est le moteur de tout ce que nous construisons.",
    cta: "Continuer à soutenir be-BOP",
  },
  ...
  agenda: {
    ...
    events: [
      ...
      {
        date: "9 juin 2026",
        name: "Campagne clôturée — objectif dépassé",
        location: "En ligne",
        active: true,
      },
      {
  ...
  obj1: {
    ...
    closedNotice:
      "La campagne est désormais clôturée. Vous pouvez toujours soutenir be-BOP et ses développements futurs sur la page de soutien.",
    supportCta: "Soutenir be-BOP",
    supportUrl: "/donation",
  },
  ...
  obj3: {
    ...
    assosLabel: "Associations que vous avez soutenues",
    tabs: [
  ...
  sidebar: {
    closedEyebrow: "Campagne terminée",
    closedTitle: "6 600 € collectés",
    closedBody:
      "La campagne est clôturée. Merci à tous nos soutiens ! Vous pouvez toujours contribuer au développement de be-BOP.",
    supportCta: "Soutenir be-BOP",
    supportUrl: "/donation",
    community: {
      eyebrow: "Communauté",

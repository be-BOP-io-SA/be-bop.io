...
export const en: PeerfundingClosedTranslations = {
  hero: {
    eyebrow: "Peerfunding be-BOP · April 27 – June 9 2026 · Campaign closed",
    title: "We built <em>PipeliNostr</em> together",
    subtitle:
      "Thank you to everyone who supported this campaign.<br><strong>Goal exceeded. Community delivered.</strong>",
    video: {
  ...
  closedBanner: {
    badge: "Campaign closed",
    title: "We exceeded our goal!",
    raised: "€6,600",
    raisedLabel: "raised",
    goal: "€5,000",
    goalLabel: "goal",
    ...
    percentLabel: "funded",
    thanks:
      "An enormous thank you to every supporter who made PipeliNostr possible. Your trust drives everything we build.",
    cta: "Continue supporting be-BOP",
  },
  ...
  agenda: {
    ...
    events: [
      ...
      {
        date: "9 June 2026",
        name: "Campaign closed — goal exceeded",
        location: "Online",
        active: true,
      },
      {
  ...
  obj1: {
    ...
    closedNotice:
      "The campaign is now closed. You can still support be-BOP and its future developments on the support page.",
    supportCta: "Support be-BOP",
    supportUrl: "/donation",
  },
  ...
  obj3: {
    ...
    assosLabel: "Associations you supported",
    tabs: [
  ...
  sidebar: {
    closedEyebrow: "Campaign closed",
    closedTitle: "€6,600 raised",
    closedBody:
      "The campaign has ended. Thank you to all our supporters! You can still support be-BOP's ongoing development.",
    supportCta: "Support be-BOP",
    supportUrl: "/donation",
    community: {
      eyebrow: "Community",
